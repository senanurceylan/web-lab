    ...
    <>
      ...
      <header className="sticky top-0 z-40 w-full bg-white/95 dark:bg-gray-900/95 backdrop-blur border-b border-gray-200 dark:border-gray-800">
        <nav className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-14 sm:h-16 flex items-center justify-between" aria-label="Ana navigasyon">
          <Link to="/" aria-label="Ana sayfa - LAB-4" className="text-lg font-semibold text-primary dark:text-primary hover:opacity-90 rounded focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:focus:ring-offset-gray-900">
            LAB-4
          </Link>
    ...
    <div className="min-h-screen bg-surface dark:bg-gray-900">
      <section id="about" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20" aria-labelledby="about-heading">
        ...
        <p className="text-muted max-w-2xl text-base sm:text-lg leading-relaxed">
          Web Programming LAB-4 — Tailwind CSS v4 ile kurulmuş bu proje, modern bileşenler ve erişilebilir yapı kullanır. Tema renkleri ve dark mode desteklenir.
        </p>
      </section>
      <section id="projects" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 border-t border-gray-200 dark:border-gray-800" aria-labelledby="projects-heading">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          <Card variant="outlined">
            <h3 className="font-semibold text-lg text-primary dark:text-primary mb-2">Bileşen Kütüphanesi</h3>
            <p className="text-muted text-sm">Button, Input, Card, Alert ve ThemeToggle bileşenleri.</p>
          </Card>
          <Card variant="outlined">
            <h3 className="font-semibold text-lg text-primary dark:text-primary mb-2">UI Kit Sayfası</h3>
            <p className="text-muted text-sm">Tüm varyantların sergilendiği demo sayfa.</p>
          </Card>
          <Card variant="outlined">
            <h3 className="font-semibold text-lg text-primary dark:text-primary mb-2">Dark Mode</h3>
            <p className="text-muted text-sm">document.documentElement üzerinde dark sınıfı ile tema değişimi.</p>
          </Card>
        </div>
      </section>
